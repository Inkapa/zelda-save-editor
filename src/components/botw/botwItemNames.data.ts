// English item id -> display name, transcribed from the source project's
// `zelda-botw.data.js` `Translations` table. Display only, ids stay the editable field.
export const BOTW_ITEM_NAMES: Record<string, string> = {
